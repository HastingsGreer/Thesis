...
A typical implementation of $\Phi$ is 
...
In this work, we also quietly developed the fundamental software for all following papers in the thesis.
\subsection{GradICON}
...
This line of research is not guaranteed to produce a powerful registration network with [W, U] equivariance to rotations, and so I commit to pursuing the above three lines of inquiry, but they may yield null results instead of a publishable result.
